def amplify(f, x):
    ...
    """
    "*** YOUR CODE HERE ***"
    #does not need to change the result to list 
    
    #for a in amplify(f, f(x)):
    #    yield x + a
    #return을 만들어버림. 하나하나 내보내야.
...
class Person:
    ...
    'Would you please preserve abstraction barriers'
    """
    initial = 'I squirreled it away before it could catch on fire.'
    def __init__(self, name):
        self.name = name
        "*** YOUR CODE HERE ***"
        self.initialSentence = self.initial

    def say(self, stuff):
        "*** YOUR CODE HERE ***"
        self.initialSentence = stuff
        return stuff
...
class SmartFridge:
    ...
    def use_item(self, item, quantity):
        "*** YOUR CODE HERE ***"
        #assume
        # the use_item method will only be called on items that are already in the fridge
        # it should use up the given quantity of the given item
